<!-- footer_start  -->
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="address_line">
                                <li>08207006053</li>
                                <li><a href="#">207006053@student.unsil.ac.id</a></li>
                                <li>Tasikmalaya</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3  col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="<?=BASEURL;?>/Web/contact">Saran</a></li>
                            </ul>
                        </div>
                    </div>
  ...
  Copyright &copy;2022 <b>Nandhitta Aemy</b> - 207006053. All rights reserved <!-- | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
