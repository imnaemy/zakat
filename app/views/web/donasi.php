...
<!-- ================ contact section start ================= -->
    <section class="contact-section">
            <div class="container">  
            <p class="sample-text">
				<b>Zakatin</b> telah berhasil mengumpulkan zakat dan telah disalurkan ke pihak-pihak yang membutuhkan. Berikut adalah rinciannya
			...
			<div class="section-top-border">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title"Ayo Berbagi!</h2>
                    </div>
                    <div class="col-lg-12">
                        <form class="form-contact contact_form" action="<?= BASEURL; ?>/Web/aksi_tambah_donasi" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="total_donasi" placeholder="Jumlah uang Yang Anda Ingin Berikan. Contoh: 100000" type="number">
                                    </div>
                                </div>
